<x-master-layout>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_order_today'] }}
                                                </h5>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_order_today_peding'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_order_today_inprogress'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_order_today_completed'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_order_today_cancelled'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                                    fill="currentColor" class="bi bi-calendar2-x" viewBox="0 0 16 16">
                                                    <path
                                ...
                                <div class="card card-block card-stretch card-height shadow-card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                                    fill="currentColor" class="bi bi-ui-checks-grid"
                                                    viewBox="0 0 16 16">
                                                    <path
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_create_order'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_assigned_order'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_accepetd_order'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                                    fill="currentColor" class="bi bi-file-check" viewBox="0 0 16 16">
                                                    <path
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_arrived_order'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_pickup_order'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_departed_order'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_delivered_order'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_cancelled_order'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ $data['dashboard']['total_delivery_person'] }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
            ...
            <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ getPriceFormat($data['dashboard']['total_collection_by_order']) }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ getPriceFormat($data['dashboard']['total_admin_comission']) }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ getPriceFormat($data['dashboard']['total_delivery_comission']) }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ getPriceFormat($data['dashboard']['total_wallet_balance']) }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mm-cart-text">
                                                ...
                                                <br>
                                                <h5 class="font-weight-700">
                                                    {{ getPriceFormat($data['dashboard']['monthly_payment_count']) }}
                                                </h5>
                                            </div>
                                            <div class="mm-cart-image text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="42"
                            ...
                            <div class="card-header ">
                                <div class="header-title">
                                    <a href="{{ route('order.index') }} "
                                        class="btn btn-sm btn-primary float-right ">{{ __('message.view_all') }}</a>
                                            ...
                                            @if(count($data['recent_order']) > 0)
                                                @foreach ($data['recent_order'] as $order)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span
                                                                class="badge bg-{{$status}}">{{ __('message.' . $order->status) }}</span>
                                                        </td>
                                                        <td><a class="mr-2" href="{{ route('order.show', $order->id) }}"><i
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card" data-aos="fade-up" data-aos-delay="1000">
                            <div class="card-header ">
                                <a href="{{ route('withdrawrequest.index') }} "
                                    class="btn btn-sm btn-primary float-right ">{{ __('message.view_all') }}</a>
                                <div class="header-title">
                    ...
                    <div class="card-body p-0">
                        <div class="rounded-md border">
                            <div class="relative w-full overflow-auto">
                                <table class="w-full caption-bottom text-sm" id="city-data-table">
    ...
    @section('bottom_script')
        <script>
            // Load ShadCN table scripts
            loadScript('{{ asset('js/shadcn-table-header.js') }}');
            loadScript('{{ asset('js/shadcn-table-filters.js') }}');
