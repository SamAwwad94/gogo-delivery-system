<script>
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $('#printDeliveryLabelsBtn').on('click', function (e) {
                e.preventDefault();
                ...
                // Open the multiple delivery labels page in a new window
                var url = "{{ route('multiple-delivery-labels') }}?print_checked_ids=" + selectedIds.join(',');
