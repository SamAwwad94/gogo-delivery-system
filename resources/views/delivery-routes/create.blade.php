@extends('layouts.app')
@section('title') {{__('message.add_form_title',['form' => __('message.delivery_route')])}} @endsection
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="font-weight-bold">{{ $pageTitle ?? __('message.add_form_title',['form' => __('message.delivery_route')]) }}</h5>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="delivery_man_id" id="delivery_man_id" class="form-control select2 @error('delivery_man_id') is-invalid @enderror" required>
                                    ...
                                    @foreach($deliveryMen as $deliveryMan)
                                        <option value="{{ $deliveryMan->id }}" {{ old('delivery_man_id') == $deliveryMan->id ? 'selected' : '' }}>{{ $deliveryMan->display_name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_location" id="start_location" class="form-control @error('start_location') is-invalid @enderror" value="{{ old('start_location') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_latitude" id="start_latitude" class="form-control @error('start_latitude') is-invalid @enderror" value="{{ old('start_latitude') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_longitude" id="start_longitude" class="form-control @error('start_longitude') is-invalid @enderror" value="{{ old('start_longitude') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <select name="orders[]" id="orders" class="form-control select2 @error('orders') is-invalid @enderror" multiple required>
                                    @foreach($pendingOrders as $order)
                                        <option value="{{ $order->id }}" {{ (old('orders') && in_array($order->id, old('orders'))) ? 'selected' : '' }}>
