                                    ...
                                    <div class="col-lg-12">
                                        <div class="custom-control custom-checkbox mb-3 form-group">
                                            ...
                                            <label class="custom-control-label"
                                                for="customCheck1">{{ __('message.i_agree_terms') }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center">
                                    <span> {{ __('message.already_have_an_account') }} <a href="{{route('auth.login')}}"
                                            class="text-primary">{{ __('message.sign_in') }}</a></span>
