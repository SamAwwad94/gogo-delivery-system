...
export default function City({ pageTitle, auth_user, assets, cities, filters }) {
                    ...
                    <nav className="mm-sidebar-menu">
                        <ul id="mm-sidebar-toggle" className="side-menu">
                            ...
                            <li className="sidebar-layout active">
                                ...
                                <ul className={`submenu ${sidebarMenuOpen ? 'collapse show' : 'collapse'}`} id="city">
                                    <li className="sidebar-layout">
                                        <a href="/city/create" className="svg-icon">
                                            <i className="fas fa-plus-square"></i>
                                            <span className="ml-2">Add City</span>
                                        </a>
                                    </li>
                                    <li className="sidebar-layout active">
                                        <a href="/city" className="svg-icon">
                                            <i className="fas fa-list"></i>
                                            <span className="ml-2">List Cities</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
