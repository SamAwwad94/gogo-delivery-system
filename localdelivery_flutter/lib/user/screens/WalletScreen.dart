                                ...
                                AppTextField(
                                  ...
                                  inputFormatters: [
                                    FilteringTextInputFormatter.allow(
                                        RegExp(r'^\d*\.?\d{0,2}$')), // Allows digits and one decimal point with up to 2 decimal places
                                  ],
          ...
          Container(
            child: Column(
              children: [
                ...
                Container(
                        decoration:
                            boxDecorationDefault(border: Border.all(color: Colors.grey.withOpacity(0.2)), color: Colors.transparent),
                        child: Text(language.copy, style: boldTextStyle(color: ColorUtils.colorPrimary, size: 14)).paddingAll(6).center())
                    .onTap(() {
                  Clipboard.setData(ClipboardData(text: data.transactionType!.split(":")[1])).then((_) {
                    snackBar(context, content: Text("${data.transactionType!.split(":")[1]}  ${language.copiedToClipboard}"));
                  });
