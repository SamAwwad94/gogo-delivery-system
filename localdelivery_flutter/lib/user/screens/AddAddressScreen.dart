                    ...
                    onTap: () async {
                      try {
                        ...
                        if (!isLocationEnabled) {
                          final shouldOpenSettings = await showConfirmDialogCustom(
                            context,
                          ...
                          if (shouldOpenSettings == true) {
                            ...
                            if (!await Geolocator.isLocationServiceEnabled()) {
                              if (mounted) toast("Location services still disabled");
                              return;
                            }
                          } else {
                            return;
                        ...
                        if (permission == LocationPermission.deniedForever || permission == LocationPermission.denied) {
                          if (mounted) {
                            final openAppSettings = await showConfirmDialogCustom(
                              context,
                              primaryColor: ColorUtils.colorPrimary,
                        ...
                        final res = await GoogleMapScreen(isSaveAddress: true).launch(context);
                        if (res != null && mounted) {
