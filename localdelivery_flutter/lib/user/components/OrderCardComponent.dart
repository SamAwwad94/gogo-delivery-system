          ...
          children: [
            Row(
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                      color: statusColor(widget.item.status.validate()).withOpacity(0.08), borderRadius: BorderRadius.circular(6)),
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child:
                      Image.asset(parcelTypeIcon(widget.item.parcelType.validate()), height: 24, width: 24, color: ColorUtils.colorPrimary),
                ),
                8.width,
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
            ...
            if (widget.item.status != ORDER_CANCELLED || (widget.item.status == ORDER_DEPARTED || widget.item.status == ORDER_ACCEPTED))
              16.height,
            Row(
