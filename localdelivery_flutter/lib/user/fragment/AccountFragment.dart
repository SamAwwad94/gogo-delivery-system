...
class AccountFragmentState extends State<AccountFragment> {
  ...
  Widget mTitle(String value) {
    return Text(value.toUpperCase(), style: boldTextStyle(size: 12, letterSpacing: 0.7, color: textSecondaryColorGlobal))
            ...
            children: [
              Column(
                ...
                children: [
                        ...
                        children: [
                          Container(
                              decoration: boxDecorationWithRoundedCorners(
                                  boxShape: BoxShape.circle, border: Border.all(width: 2, color: ColorUtils.colorPrimary)),
                  ...
                  Container(
                    decoration: boxDecorationWithRoundedCorners(
                        border: Border.all(color: ColorUtils.colorPrimary, width: 1), backgroundColor: Colors.transparent),
                    padding: EdgeInsets.all(16),
                    width: context.width(),
                    child:
                        Text(language.logout, style: boldTextStyle(size: 18, color: ColorUtils.colorPrimary), textAlign: TextAlign.center),
                  ).onTap(() async {
