...
class OrderDetailWithBidScreen extends StatefulWidget {
  ...
  @override
  OrderDetailWithBidScreenState createState() => OrderDetailWithBidScreenState();
}
...
class OrderDetailWithBidScreenState extends State<OrderDetailWithBidScreen> {
  ...
  declineOrCancelBid({required bool isDecline}) async {
    appStore.setLoading(true);
    Map req = {"id": orderData!.id, "delivery_man_id": getIntAsync(USER_ID).toString(), "is_bid_accept": isDecline ? "2" : "3"};
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                                              ...
                                              Row(
                                                children: [
                                                  Text(language.distance,
                                                      style: secondaryTextStyle(size: 14), overflow: TextOverflow.ellipsis, maxLines: 1),
                                                  4.width,
                                                  Text(distance ?? "0",
                                                      style: boldTextStyle(), overflow: TextOverflow.ellipsis, maxLines: 1),
                                                ],
                                              ),
                                              Row(
                                                children: [
                            ...
                            Text(language.shippedVia, style: boldTextStyle(size: 16)).visible(
                                courierDetails != null && (orderData!.status != ORDER_CREATED && orderData!.status != ORDER_DELIVERED)),
                            12.height.visible(
                                courierDetails != null && orderData!.status != ORDER_CREATED && (orderData!.status != ORDER_DELIVERED)),
                                                    ...
                                                    ? Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          InkWell(
                                                              ...
                                                              child: Icon(Ionicons.call_outline, size: 22, color: ColorUtils.colorPrimary))
                                                        ],
                                                      )
                                                    : SizedBox()
                                              ],
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Text(orderData!.extraCharges.keys.elementAt(index).replaceAll("_", " "),
                                                          style: primaryTextStyle()),
                                                      16.width,
                                                      Text('${printAmount(orderData!.extraCharges.values.elementAt(index))}',
                                                          style: primaryTextStyle()),
                                                    ],
                                                  ),
                                                );
