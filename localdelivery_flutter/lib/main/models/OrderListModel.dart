...
class OrderData {
  ...
  OrderData.fromJson(Map<String, dynamic> json) {
    ...
    extraChargesList =
        json['extra_charge_list'] != null ? List<ExtraCharges>.from(json['extra_charge_list'].map((x) => ExtraCharges.fromJson(x))) : [];
  ...
  Map<String, dynamic> toJson() {
    ...
    data["packaging_symbols"] = packagingSymbols == null ? [] : List<PackagingSymbol>.from(this.packagingSymbols!.map((x) => x.toJson()));
    return data;
  }
}
