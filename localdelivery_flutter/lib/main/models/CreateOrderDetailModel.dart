...
class CreateOrderDetailsResponse {
  ...
  CreateOrderDetailsResponse.fromJson(Map<String, dynamic> json) {
    try {
      ...
      log("CreateOrderDetailsResponse     ${e}, ${s}");
    }
  }
...
class AppSettingDetail {
  ...
  AppSettingDetail({this.currencyCode, this.currency, this.currencyPosition, this.isVehicleInOrder, this.isBiddingEnabled, this.isSmsOrder});
