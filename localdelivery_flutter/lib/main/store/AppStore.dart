...
abstract class _AppStore with Store {
  ...
  ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(color: ColorUtils.colorPrimary, elevation: 0, systemOverlayStyle: SystemUiOverlayStyle(statusBarIconBrightness: Brightness.light, statusBarColor: Colors.transparent)),
  ...
  void updateTheme(Color newColor) {
    ...
    lightTheme = ThemeData(
      ...
      cardColor: Colors.white,
      tabBarTheme: TabBarTheme(labelColor: Colors.black),
      appBarTheme: AppBarTheme(color: newColor, elevation: 0, systemOverlayStyle: SystemUiOverlayStyle(statusBarIconBrightness: Brightness.light, statusBarColor: Colors.transparent)),
      dialogTheme: DialogTheme(shape: dialogShape()),
      bottomSheetTheme: BottomSheetThemeData(backgroundColor: Colors.white),
      colorScheme: ColorScheme.light(
        primary: newColor,
