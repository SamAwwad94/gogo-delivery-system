    ...
    return CommonScaffoldComponent(
      ...
      appBar: commonAppBarWidget(
        ...
        titleWidget: Row(
          ...
          children: [
            CircleAvatar(
                backgroundColor: context.cardColor, backgroundImage: NetworkImage(widget.userData!.profileImage.validate()), minRadius: 20),
            10.width,
            Column(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Container(
              ...
              child: PaginateFirestore(
                ...
                query: ordersMessageService.chatMessagesWithPagination(
                    currentUserId: getStringAsync(UID), receiverUserId: widget.userData!.uid.validate(), orderId: widget.orderId),
