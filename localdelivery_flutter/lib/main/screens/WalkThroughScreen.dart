        ...
        actions: [
          Text(language.skip, style: boldTextStyle(color: grey)).onTap(
            () async {
              ...
              LoginScreen()
                  .launch(context, isNewTask: true, duration: Duration(milliseconds: 1000), pageRouteAnimation: PageRouteAnimation.Scale);
            },
                        ...
                        : commonButton(
                            ...
                            () async {
                              ...
                              LoginScreen().launch(context,
                                  isNewTask: true, duration: Duration(milliseconds: 1000), pageRouteAnimation: PageRouteAnimation.Scale);
                            },
                          ),
                  ],
                ),
