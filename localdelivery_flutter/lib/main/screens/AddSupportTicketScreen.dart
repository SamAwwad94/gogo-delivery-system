...
class AddSupportTicketScreen extends StatefulWidget {
  int? orderId;
  AddSupportTicketScreen({super.key, this.orderId});
...
class _AddSupportTicketScreenState extends State<AddSupportTicketScreen> {
  ...
  List<String> supportTypeForOrdersOnly = [
  ...
  void init() async {
    ...
    selectedSupportType = (widget.orderId != null && widget.orderId != 0) ? supportTypeForOrdersOnly[0] : supportType[0];
  }
  ...
  Future saveCustomerSupportApi() async {
    ...
    if (widget.orderId != null && widget.orderId != 0) multiPartRequest.fields['order_id'] = widget.orderId.toString();
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      value: (widget.orderId != null && widget.orderId != 0) ? supportTypeForOrdersOnly[0] : supportType[0],
                      dropdownColor: context.cardColor,
                      items: (widget.orderId != null && widget.orderId != 0)
                          ? supportTypeForOrdersOnly.map((String e) {
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                          ...
                          child: Text(language.image, style: boldTextStyle(size: 12)).paddingAll(6).center().onTap(() async {
                            image = null;
                      ...
                      Container(
                              height: 38,
                              decoration: boxDecorationWithRoundedCorners(
                                  border: Border.all(color: Colors.grey.withOpacity(0.2)), backgroundColor: Colors.transparent),
                  ...
                  if (image != null && !image!.path.isEmptyOrNull)
                    Container(
                      ...
                      child: Image.file(File(image!.path),
                              height: 150, width: MediaQuery.of(context).size.width, fit: BoxFit.cover, alignment: Alignment.center)
