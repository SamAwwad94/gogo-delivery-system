...
class RefactoredDeliveryManController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->has('classic') && request()->classic == 1) {
            ...
            $dataTable = new DeliverymanDataTable();
    ...
    /**
     * Display a listing of delivery men with Inertia/React.
     *
    ...
    public function shadcnIndex()
    {
        ...
        $drivers = $this->deliveryManService->getAllDeliveryMen($perPage, $filters);
