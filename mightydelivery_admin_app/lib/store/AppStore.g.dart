...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$isShowVehicleAtom =
      Atom(name: '_AppStore.isShowVehicle', context: context);

  @override
  int get isShowVehicle {
    _$isShowVehicleAtom.reportRead();
    return super.isShowVehicle;
  }

  @override
  set isShowVehicle(int value) {
    _$isShowVehicleAtom.reportWrite(value, super.isShowVehicle, () {
      super.isShowVehicle = value;
    });
  }
  ...
  void showVehicleDialog(int val) {
    final _$actionInfo = _$_AppStoreActionController.startAction(
        name: '_AppStore.showVehicleDialog');
    try {
      return super.showVehicleDialog(val);
    } finally {
      _$_AppStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  void setEmailVerification(int val) {
    final _$actionInfo = _$_AppStoreActionController.startAction(
        name: '_AppStore.setEmailVerification');
    try {
      return super.setEmailVerification(val);
    } finally {
      _$_AppStoreActionController.endAction(_$actionInfo);
    }
  }
