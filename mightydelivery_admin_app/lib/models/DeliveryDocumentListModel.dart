...
class DeliveryDocumentData {
  ...
  DeliveryDocumentData({this.id, this.deliveryManId, this.documentId, this.documentName, this.isVerified, this.deliveryManDocument, this.createdAt, this.updatedAt, this.deletedAt, this.deliveryManName});
