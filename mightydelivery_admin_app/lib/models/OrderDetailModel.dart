...
class OrderDetailModel {
  ...
  OrderDetailModel({this.data, this.orderHistory, this.courierCompanyDetail});
  ...
  OrderDetailModel.fromJson(Map<String, dynamic> json) {
    ...
    courierCompanyDetail= json["courier_company_detail"] == null ? null : CourierCompanyDetail.fromJson(json["courier_company_detail"]);
...
class CourierCompanyDetail {
  ...
  factory CourierCompanyDetail.fromJson(Map<String, dynamic> json) => CourierCompanyDetail(
    id: json["id"],
    name: json["name"],
    link: json["link"],
    image: json["image"],
