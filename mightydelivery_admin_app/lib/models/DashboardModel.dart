...
class DashboardModel {
  ...
  DashboardModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['recent_order'] != null) {
      recentOrder = <OrderModel>[];
      json['recent_order'].forEach((v) {
        recentOrder!.add(new OrderModel.fromJson(v));
      });
    }
...
class NotificationSettings {
  ...
  NotificationSettings({this.active, this.create, this.failed, this.delayed, this.cancelled, this.completed, this.courierArrived, this.courierAssigned, this.courierDeparted, this.courierTransfer, this.courierPickedUp, this.paymentStatusMessage});
