class AppSettingModel {
  ...
  String? distanceUnit;
  num? distance;
  int? isOtpVerifyOnPickupDelivery;
  String? currency;
  String? currencyCode;
  String? currencyPosition;
  int? isVehicleInOrder;
  String? prefix;
  String? insuranceAllow;
  ...
  AppSettingModel({
    ...
    this.distanceUnit,
    this.distance,
    this.isOtpVerifyOnPickupDelivery,
    this.currency,
    this.currencyCode,
  ...
  factory AppSettingModel.fromJson(Map<String, dynamic> json) {
    return AppSettingModel(
      ...
      isOtpVerifyOnPickupDelivery: json['otp_verify_on_pickup_delivery'],
      currency: json['currency'],
      currencyCode: json['currency_code'],
      currencyPosition: json['currency_position'],
      isVehicleInOrder: json['is_vehicle_in_order'],
      prefix: json['prefix'],
      insuranceAllow: json['insurance_allow'],
  ...
  Map<String, dynamic> toJson() {
    ...
    data['otp_verify_on_pickup_delivery'] = this.isOtpVerifyOnPickupDelivery;
    data['currency'] = this.currency;
    data['currency_code'] = this.currencyCode;
    data['currency_position'] = this.currencyPosition;
    data['is_vehicle_in_order'] = this.isVehicleInOrder;
    data['prefix'] = this.prefix;
    data['insurance_allow'] = this.insuranceAllow;
