...
class WebsiteTermConditionScreen extends StatefulWidget {
  static String route = '/websitetermcondition';
  const WebsiteTermConditionScreen({super.key});

  @override
  State<WebsiteTermConditionScreen> createState() => _WebsiteTermConditionScreenState();
}

class _WebsiteTermConditionScreenState extends State<WebsiteTermConditionScreen> {
  GlobalKey<FormState> formKey = GlobalKey<FormState>();
  HtmlEditorController termConditionController = HtmlEditorController();
              ...
              children: [
               /* Form(
                ...
                HtmlEditor(
                  ...
                  callbacks: Callbacks(
                    onInit: () async {
                      termConditionController.setText(frontEndData!.termAndCondition.validate());
                    },
                  ),
              ...
              child: dialogPrimaryButton(language.save, () async {
                if (getStringAsync(USER_TYPE) == DEMO_ADMIN) {
                  ...
                  if (getStringAsync(USER_TYPE) == DEMO_ADMIN) {
                    ...
                    String description = await termConditionController.getText();
