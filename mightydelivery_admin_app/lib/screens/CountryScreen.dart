                          ...
                          Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(mData.name.toString(), style: boldTextStyle()).expand(),
                                  // Spacer(),
                                  GestureDetector(
                                    child: Container(
                                    ...
                                    onTap: () {
                                      mData.deletedAt == null
                                          ? commonConfirmationDialog(context, mData.status == 1 ? DIALOG_TYPE_DISABLE : DIALOG_TYPE_ENABLE, () {
                                              ...
                                              title: mData.status != 1 ? language.enableCountry : language.disableCountry,
                                              subtitle: mData.status != 1 ? language.enableCountryMsg : language.disableCountryMsg)
