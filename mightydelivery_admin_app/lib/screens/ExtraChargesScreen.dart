...
class ExtraChargesScreenState extends State<ExtraChargesScreen> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: appBarWidget(language.extraCharges, actions: [
                                ...
                                onTap: () {
                                  mData.deletedAt == null
                                      ? commonConfirmationDialog(context, mData.status == 1 ? DIALOG_TYPE_DISABLE : DIALOG_TYPE_ENABLE, () {
                                          ...
                                          title: mData.status != 1 ? language.enableExtraCharge : language.disableExtraCharge,
                                          subtitle: mData.status != 1 ? language.enableExtraChargeMsg : language.disableExtraChargeMsg)
