      ...
      child: Scaffold(
        appBar: appBarWidget(
          ...
          actions: [
            ...
            }).paddingOnly(right: 12, left: appStore.selectedLanguage == "ar" ? 12 : 0)
          ],
        ),
                      ...
                      children: [
                              ...
                              onTap: () {
                                mData.deletedAt == null
                                    ? commonConfirmationDialog(context, mData.status == 1 ? DIALOG_TYPE_DISABLE : DIALOG_TYPE_ENABLE, () {
                                        ...
                                        title: mData.status != 1 ? language.enableDocument : language.disableDocument,
                                        subtitle: mData.status != 1 ? language.enableDocumentMsg : language.disableDocumentMsg)
                        ...
                        Visibility(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.check_circle, size: 18, color: appStore.isDarkMode ? white : primaryColor),
                                  SizedBox(width: 4),
                                  Text(language.required, style: primaryTextStyle(color: appStore.isDarkMode ? white : primaryColor)),
                                ],
                              ),
                            )),
                      ],
