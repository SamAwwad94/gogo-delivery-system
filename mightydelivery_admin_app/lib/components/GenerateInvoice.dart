...
generateInvoiceCall(OrderModel orderData) async {
  ...
  final invoice = Invoice(
    ...
    items: [
      InvoiceItem(
        product: '${orderData.parcelType} (${orderData.totalWeight} ${appStore.countryList.isNotEmpty ? '${appStore.countryList.firstWhere((element) => element.id == orderData.countryId).weightType ?? 'kg'}' : 'kg'})',
        description: language.deliveryCharges,
