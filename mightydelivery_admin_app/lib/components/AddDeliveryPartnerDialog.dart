...
class AddDeliveryPartnerDialog extends StatefulWidget {
  static String tag = '/DeliveryPartnerDialog';
  final bool? isAdd;
  final Function()? onUpdate;
  final Benefits? data;
  AddDeliveryPartnerDialog({super.key, this.isAdd = true, this.onUpdate, this.data});
            ...
            children: [
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    8.height,
                    Text('${widget.isAdd! ? language.add : language.edit} ${language.deliveryPartnerBenefits}', style: boldTextStyle(color: appStore.isDarkMode ? white : primaryColor, size: 20)),
                    16.height,
                    Row(
                      children: [
