            ...
            <div class="mm-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="{{ asset('/') }}" class="header-logo">
                    <img src="{{ \App\Helpers\LogoHelper::getLogo('site_logo') }}"
                        class="img-fluid mode light-img rounded-normal site_logo_preview " alt="logo">
                    <img src="{{ \App\Helpers\LogoHelper::getLogo('site_dark_logo') }}"
                        class="img-fluid mode dark-img rounded-normal darkmode-logo site_dark_logo_preview"
                        alt="dark-logo">
                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="search-toggle dropdown-toggle notification_list" id="dropdownMenuButton"
                                ...
                                <span
                                    class="badge badge-pill badge-primary badge-up notify_count count-mail d-none"></span>
                                <span class="bg-primary dots d-none"></span>
                            </a>
                            <div class="mm-sub-dropdown dropdown-menu notification-menu"
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="search-toggle dropdown-toggle" id="languageDropdownMenu"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                @php
                                ...
                                @endphp
                                <i class="fas fa-globe text-primary selected-lang" style="font-size: 20px;"
                                    id="mm-language-icon" aria-hidden="true"></i>
                                <span class="bg-primary"></span>
                            </a>
                            <div class="mm-sub-dropdown dropdown-menu language-menu"
                                            ...
                                            @if(count($language_array) > 0)
                                                @foreach($language_array as $lang)
                                                    <li class="dropdown-item-1 list-group-item px-2">
                                                        <a class="p-0" data-lang="{{ $lang['id'] }}"
                                                            href="{{ route('change.language', ['locale' => $lang['id']]) }}">
                                                            @php
                                                                $flag_path = file_exists(public_path('/images/flag/' . $lang['id'] . '.png')) ? asset('/images/flag/' . $lang['id'] . '.png') : asset('/images/lang_flag.png');
                                                            @endphp
                                                            <img src="{{ $flag_path }}" alt="img-flag-{{ $lang['id'] }}"
                                                                class="img-fluid mr-2 selected-lang-list" />
                                                            {{ $lang['title'] }}
                                                        </a>
                                                    </li>
                                                @endforeach
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="nav-item nav-icon dropdown-toggle pr-0 search-toggle"
                                ...
                                aria-expanded="false">
                                <img src="{{ getSingleMedia(auth()->user(), 'profile_image', null) }}"
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                <li class="dropdown-item d-flex ">
                                    ...
                                    <a
                                        href="{{ route('setting.index', ['page' => 'profile_form']) }}">{{ __('message.my_profile') }}</a>
                                </li>
                                <li class="dropdown-item d-flex ">
                                ...
                                <li class="dropdown-item d-flex border-top">
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        <a href="javascript:void(0)" class="pl-1" onclick="event.preventDefault();
...
<script>
    // Language icon handler similar to other navigation icons
    $(document).ready(function () {
        $('#mm-language-icon').on('click', function (e) {
            e.preventDefault();
            // Any custom behavior for language icon can be added here
