                        ...
                        <div class="d-flex justify-content-between align-items-center p-3">
                                ...
                                <div class="btn-group" style="margin-left:78%">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#"
                                            onclick="printLabel({{ $id }})">{{ __('message.print_label') }}</a>
                                        <a class="dropdown-item" href="#"
                                            onclick="printbarcode({{ $id }})">{{ __('message.print_barcode') }}</a>
                                        <a class="dropdown-item" href="{{ route('delivery-label', $id) }}"
                                            target="_blank">{{ __('message.delivery_label') }}</a>
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="">
                                @if(Auth::user()->user_type == 'admin')
                                    <a href="{{ route('order.index') }}" class="float-right ml-1 btn btn-sm btn-primary"><i
                                            class="fa fa-angle-double-left"></i> {{ __('message.back') }}</a>
                                @else
                                    <a href="{{ route('home') }}" class="float-right ml-1 btn btn-sm btn-primary"><i
                                            class="fa fa-angle-double-left"></i> {{ __('message.back') }}</a>
                                @endif
                            </div>
                        </div>
                ...
                <div class="card-body mt-0 pt-0 pb-0">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-block">
                                <div class="col-md-12 mb-3 bg-dark-danger">
                                    {{-- <h5 class="text-warning mt-2">{{ __('message.order_has_been_shipped') . '' .
                                        __('message.via') . '' . $courierCompany->name . ' : ' .
                                        dateAgoFormate($data->shipped_verify_at)}}</h5> --}}
                                    <h5 class="text-warning mt-2">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card card-block">
                            <div class="card-body mt-3 pt-0 pb-0">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="card-title mb-2 font-weight-bold">{{ __('message.parcel_details') }}
                                        </h4>
                                        <div class="card card-block">
                                            <div class="col-md-12">
                                                <h6 class="card-title mb-2 mt-2 float-left">
                                                    {{ __('message.parcel_type') }}</h6>
                                                <p class="mb-2 mt-2 float-right">
                                                    {{ isset($data->parcel_type) ? $data->parcel_type : '-' }}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h6 class="card-title mb-2 mt-2 float-left">
                                                    {{ __('message.total_weight') }}</h6>
                                                <p class="mb-2 mt-2 float-right">
                                                    {{ isset($data->total_weight) ? $data->total_weight : '-' }}
                                                    {{optional($data->country)->weight_type}}</p>
                                            </div>
                                            <div class="col-md-12">
                                                <h6 class="card-title mb-2 mt-2 float-left">
                                                    {{ __('message.total_parcel') }}</h6>
                                                <p class="mb-2 mt-2 float-right">
                                                    {{ isset($data->total_parcel) ? $data->total_parcel : '-' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <h4 class="card-title mb-2 font-weight-bold">{{ __('message.payment_details') }}
                                        </h4>
                                        <div class="card card-block">
                                            <div class="col-md-12">
                                                <h6 class="card-title mb-2 mt-2 float-left">
                                                    {{ __('message.payment_type') }}</h6>
                                                <p class="mb-2 mt-2 float-right">
                                                    {{ isset($data->payment) ? optional($data->payment)->payment_type : (isset($data->payment_type) ? $data->payment_type : '-') }}
                                                </p>
                                            </div>
                                            <div class="col-md-12">
                                                <h6 class="card-title mb-2 mt-2 float-left">
                                                    {{ __('message.payment_status') }}</h6>
                                                <p class="mb-2 mt-2 float-right">
                                                    {{ isset($data->payment) ? optional($data->payment)->payment_status : '-' }}
                                                </p>
                                            </div>
                                            <div class="col-md-12">
                                                <h6 class="card-title mb-2 mt-2 float-left">
                                                    {{ __('message.payment_collect_from') }}</h6>
                                                <p class="mb-2 mt-2 float-right">
                            ...
                            <div class="card-body pb-0 pt-0">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="card-title mb-2 font-weight-bold">{{ __('message.pickup_address') }}
                                        </h4>
                                        <div class="card card-block">
                                            <div class="col-md-12">
                                                @if($data['status'] == 'courier_picked_up' || $data['status'] == 'completed' || $data['status'] == 'courier_departed')
                                                    <p class="mb-3 mt-3"><span>{{__('message.picked')}}</span>
                                                        {{ dateAgoFormate($data->pickup_datetime) }}</p>
                                                @endif
                                                ...
                                                <h6 class=" mb-3 mt-3"> <i class="fas fa-phone-alt"></i>
                                                ...
                                                @if(!empty($data->pickup_point['name']))
                                                    <p class="mb-2 mt-2"> <i class="fa-solid fa-user"></i>
                                                        {{ $data->pickup_point['name'] }}</p>
                                                @endif
                                                @if(!empty($data->pickup_point['description']))
                                                    <p class="mb-2 mt-2"> <strong>{{ __('message.description') }}:</strong>
                                                        {{ $data->pickup_point['description'] }}</p>
                                                @endif
                                                @if(!empty($data->pickup_point['instruction']))
                                                    <p class="mb-2 mt-2"> <strong>{{ __('message.instruction') }}:</strong>
                                                        {{ $data->pickup_point['instruction'] }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <h4 class="card-title mb-2 font-weight-bold">
                                            {{ __('message.delivery_address') }}</h4>
                                        <div class="card card-block">
                                            <div class="col-md-12">
                                                @if($data['status'] == 'completed')
                                                    <p class="mb-3 mt-3"><span>{{__('message.delivered_at')}}</span>
                                                        {{  dateAgoFormate($data->delivery_datetime) }}</p>
                                                @endif
                                                <p class="mb-3 mt-3 d-flex align-items-start">
                                                    <i class="fa fa-location-dot me-2"></i>
                                                ...
                                                @if(!empty($data->delivery_point['name']))
                                                    <p class="mb-2 mt-2"> <i class="fa-solid fa-user"></i>
                                                        {{ $data->delivery_point['name'] }}</p>
                                                @endif
                                                @if(!empty($data->delivery_point['description']))
                                                    <p class="mb-2 mt-2"> <strong>{{ __('message.description') }}:</strong>
                                                        {{ $data->delivery_point['description'] }}</p>
                                                @endif
                                                @if(!empty($data->delivery_point['instruction']))
                                                    <p class="mb-2 mt-2"> <strong>{{ __('message.instruction') }}:</strong>
                                                        {{ $data->delivery_point['instruction'] }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body pb-1 pt-1">
                                            <div class="row">
                                                <div class="col-md-12 mb-1 mt-2 bg-dark-success">
                                                    <h4 class="card-title mb-2 font-weight-bold text-success">
                                                        {{ __('message.customers_supports') }}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pb-0 pt-0">
                                <div class="row">
                                    @if ($data['status'] == 'courier_picked_up' || $data['status'] == 'completed' || $data['status'] == 'courier_departed')
                                        <div class="col-md-6">
                                            <h4 class="card-title mb-1 font-weight-bold">
                                                {{ __('message.pickup_signature') }}</h4>
                                                    ...
                                                    <div id="image-preview" class="d-flex flex-wrap col-md-12 ">
                                                        @foreach(optional($data)->getMedia('pickup_time_signature') as $media)
                                                            <div class="col-md-4 mb-2 float-left">
                                                                <a class="magnific-popup-image-gallery"
                                                                    href="{{ $media->getUrl() }}" title="{{ $media->name }}">
                                                                    <img id="{{ $media->id }}_preview" src="{{ $media->getUrl() }}"
                                                                        alt="{{ $media->name }}" class="attachment-image mt-3">
                                                                </a>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                            ...
                                            @else
                                                <div class="card card-block">
                                                    <div class="col-md-12">
                                                        <img class="img-thumbnail w-50 d-block mx-auto image-fluid mb-2 mt-2 profile_image_preview"
                                                            src="{{ getSingleMedia($data, 'default', null) }}" alt="profile-pic">
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                    ...
                                    @if($data['status'] == 'completed')
                                        <div class="col-md-6">
                                            <h4 class="card-title mb-1 font-weight-bold">
                                                {{ __('message.delivery_signature') }}</h4>
                                                        ...
                                                        <div class="ml-2 mb-2">
                                                            <a href="{{ $file->getUrl() }}" target="_blank">
                                                                <img src="{{ $file->getUrl() }}" alt="{{ $file->file_name }}"
                                                                    width="100" class="img-fluid rounded avatar-100">
                                                            </a>
                                                        </div>
                                                    @endif
                                                @endforeach
                            ...
                            @if($data['status'] == 'cancelled')
                                <div class="card-body mt-0 pt-0 pb-0">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="card-title mb-2 font-weight-bold">
                                                {{ __('message.cancelled_reason') }}</h4>
                                            <div class="card card-block">
                                                <div class="col-md-12 mb-3 bg-dark-danger">
                            ...
                            @if($data['reason'] != null && $data['status'] != 'cancelled')
                                <div class="card-body mt-0 pt-0 pb-0">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="card-title mb-2 font-weight-bold">{{ __('message.return_reason') }}
                                            </h4>
                                            <div class="card card-block">
                                                <div class="col-md-12 mb-3 bg-dark-danger">
                                                    <h5 class="text-danger mt-2">{{ $data['reason'] }}</h5>
                                                    <a
                                                        href="{{ route('order-view.show', $data['parent_order_id']) }}">{{ __('message.view_old_order')}}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-block">
                                                <div class="col-md-12 mb-3 bg-dark-danger">
                                                    ...
                                                    <a
                                                        href="{{ route('order-view.show', $complate_data->id) }}">{{ __('message.view_new_order')}}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table style="border-style:none" class="table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>{{ $data->currency }}{{ number_format((float) $data->fixed_charges, 2, '.', '') }}
                                                        </td>
                                                    </tr>
                                                    @if ($data->weight_charge != null)
                                                        <tr>
                                                            <td>{{ __('message.weight_charge') }}</td>
                                                            <td>{{ $data->currency }}{{ number_format((float) $data->weight_charge, 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if ($data->vehicle_charge != null)
                                                        <tr>
                                                            ...
                                                            <td>{{ $data->currency }}{{ number_format((float) $data->vehicle_charge, 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if ($data['distance_charge'] != '0')
                                                        <tr>
                                                            ...
                                                            <td>{{ $data->currency }}{{ number_format((float) $data->distance_charge, 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if ($data['insurance_charge'] != '0')
                                                        <tr>
                                                            ...
                                                            <td>{{ $data->currency }}{{ number_format((float) $data->insurance_charge, 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    @if ($data['discount_amount'] != '0')
                                                        <tr>
                                                            ...
                                                            <td style="color: red;">
                                                                {{ $data->currency }}
                                                                {{ number_format((float) $data->discount_amount, 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if($data['status'] != 'cancelled')
                                                            ...
                                                            <td class="font-weight-bold">
                                                                {{$data->currency}}{{ number_format((float) $total_amount, 2, '.', '') }}
                                                            </td>
                                                        @endif
                                                    </tr>
                                                    @if($data['status'] == 'cancelled')
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold">{{ __('message.cancel_charges') }}
                                                            </td>
                                                            <td class="font-weight-bold">
                                                                {{ number_format((float) $total_with_cancel_charges, 2, '.', '') }}
                                                            </td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                    ...
                    <div class="col-md-4">
                        ...
                        @else
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-0"> {{ __('message.about_user') }}</h4>
                                    <hr>
                                    <div class="mt-2">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <img class="rounded-circle d-block mx-auto image-fluid mb-3 profile_image_preview"
                                                    src="{{ getSingleMedia($data->client, 'profile_image', null) }}"
                                                    alt="profile-pic" width="80px" height="80px">
                                            </div>
                                            <div class="col-md-8">
                                                <a href="{{ route('users.show', $data->client_id ?? '') }}"
                                                    class="text-auto mt-1">{{ optional($data->client)->name ?? ''  }}</a>
                                                <h6 class="mt-1 ">
                                                    {{ maskSensitiveInfo('email', optional($data->client)->email) }}</h6>
                                                <h6 class="mt-1 ">
                        ...
                        @if($data['delivery_man_id'] != null)
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-0"> {{ __('message.about_delivery_man') }}</h4>
                                    <hr>
                                    <div class="mt-2">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <img class="rounded-circle d-block mx-auto image-fluid mb-3 profile_image_preview"
                                                    src="{{ getSingleMedia($data->delivery_man, 'profile_image', null) }}"
                                                    alt="profile-pic" width="80px" height="80px">
                                            </div>
                                            <div class="col-md-8">
                                                <a href="{{ route('deliveryman.show', $data->delivery_man_id ?? '') }}"
                                                    class="text-auto mt-1">
                                                    {{ optional($data->delivery_man)->name ?? '' }}</a>
                                                <h6 class="mt-1">
                                            ...
                                            <div class="col-md-12 mt-3 text-center">
                                                <a href="{{ route('ordervehicleinfo-vehicle', $data->id) }}"
                                                    class="d-inline-block loadRemoteModel">{{ __('message.view_vehicleinformation')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @if(isset($data) && optional($data->vehicle)->hasMedia('vehicle_image'))
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="mb-2 flex-wrap col-md-12 text-start">{{ __('message.vehicle') }}</h4>
                                            <hr>
                                        </div>
                                        <div id="image-preview" class="d-flex flex-wrap col-md-12">
                                            @foreach(optional($data->vehicle)->getMedia('vehicle_image') as $media)
                                                <div class="col-md-6 mb-0 float-left">
                                                    <a class="image-popup-vertical-fit" href="{{ $media->getUrl() }}"
                                                        title="{{ $media->name }}">
                                                        <img id="{{ $media->id }}_preview" src="{{ $media->getUrl() }}"
                                                            alt="{{ $media->name }}" class="attachment-image mt-1 w-100">
                                                    </a>
                                                </div>
                                            @endforeach
                                            <div id="image-preview" class="d-flex flex-wrap col-md-6 ">
                                                <h6 class="mb-2 flex-wrap  text-left">{{ __('message.vehicle_name') }}</h6>
                                                <p class="mb-2 flex-wrap col-md-6 text-left">
                                                    {{optional($data->vehicle)->title}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @if($data['status'] == 'completed' && $data['is_shipped'] == 1)
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4 class="mb-2 flex-wrap col-md-12 text-start">
                                                {{ __('message.courier_companies') }}</h4>
                                            <hr>
                                        </div>
                                        <div class="col-md-12  pr-0 pl-0">
                                            ...
                                            <div class="col-md-9 float-right pr-0 pl-0">
                                                <li class="fw-normal " style="list-style-type: none; padding: 0;">
                                                    {{ $courierCompany->name ?? '-' }}</li>
                                                <li class="fw-normal mt-2" style="list-style-type: none; padding: 0;">
                                                    <a href="{{ $courierCompany->link ?? '#' }}" target="_blank"
                        ...
                        @if(in_array($data['status'], ['courier_departed', 'courier_picked_up']))
                            ...
                            ->attributeIf($disabled, 'disabled') !!}
                                                            ...
                                                            @endphp
                                                            <div class="form-group col-md-12 mt-2" id="couriercompany_tracking_id"
                                                                style="{{ $data->couriercompany_id ? '' : 'display: none;' }}">
                            ...
                            ->attributeIf($readonly, 'readonly') !!}
                                                            ...
                                                            <div class="form-group col-md-12 mt-2" id="tracking_details"
                                                                style="{{ $data->tracking_details ? '' : 'display: none;' }}">
                            ...
                            ->required() !!}
                                                            ...
                                                            <div class="form-group col-md-12 mt-2" id="tracking_number"
                                                                style="{{ $data->tracking_number ? '' : 'display: none;' }}">
                            ...
                            ->attributeIf($disabled, 'disabled') !!}
                                                            ...
                                                            @endphp
                                                            <div class="form-group col-md-12 mt-2" id="shipping_provider"
                                                                style="{{ $data->tracking_details ? '' : 'display: none;' }}">
                            ...
                            ->attributeIf($readonly, 'readonly') !!}
                                                            ...
                                                            <div class="form-group col-md-12 mt-2" id="date_shipped"
                                                                style="{{ $data->date_shipped ? '' : 'display: none;' }}">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="mb-2 flex-wrap col-md-12 text-first">{{ __('message.orderhistory') }}
                                        </h4>
                                        <hr>
                                        @if(count($data->orderhistory) > 0)
                                            <div class="card card-block">
                                                <div class="card-body">
                                                    <div
                                                        class="mm-timeline0 m-0 d-flex align-items-center justify-content-between position-relative">
                                                            ...
                                                            @foreach($data->orderhistory as $history)
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <h6 class="float-left mb-1">
                                                                        {{ __('message.' . $history->history_type)}}</h6>
                                                                    <small
                                                                        class="float-right mt-1">{{ dateAgoFormate($history->created_at) }}</small>
                                                                    <div class="d-inline-block w-100">
                                                                        <p>
                                                                            {{ $history->history_message }}
                                                                            @if($deliveryManId)
                                                                                <a href="{{ route('deliveryman-view.show', $deliveryManId) }}"
                                                                                    class="link-success">{{ __('message.view_more') }}</a>
                                                                            @endif
                                                                        </p>
                                                                    </div>
                                                                </li>
