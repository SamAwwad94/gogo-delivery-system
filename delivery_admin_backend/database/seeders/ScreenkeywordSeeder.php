          ...
          [
            ...
            "keyword_data"=> [
              ...
              [
                ...
                "keyword_value"=> "Session Expired"
              ],
              [
                "screenId"=> "4",
                "keyword_id"=> 616,
                "keyword_name"=> "sessionExpiredMsg",
                "keyword_value"=> "Your session has expired. Please log in again."
              ],
              [
                "screenId"=> "4",
                "keyword_id"=> 617,
                "keyword_name"=> "urlLaunchError",
                "keyword_value"=> "Could not launch the URL"
              ]
            ]
          ],
          [
          ...
          [
            ...
            "keyword_data"=> [
              ...
              [
                ...
                "keyword_value"=> "Offers & Benefits"
              ],
              [
                "screenId"=> "19",
                "keyword_id"=> 599,
                "keyword_name"=> "onThisOrder",
                "keyword_value"=> "on this order"
              ],
              [
                "screenId"=> "19",
                "keyword_id"=> 600,
                "keyword_name"=> "moreCoupons",
                "keyword_value"=> "More coupons"
              ]
            ]
          ],
          [
          ...
          [
            ...
            "keyword_data"=> [
              ...
              [
                ...
                "keyword_value"=> "You can only add 3 proof data."
              ]
            ]
          ],
          [
          ...
          [
            ...
            "keyword_data"=> [
              [
                ...
                "keyword_value"=> "Coupon List"
              ],
              [
                "screenId"=> "58",
                "keyword_id"=> 604,
                "keyword_name"=> "expiresIn",
                "keyword_value"=> "Expires In=>"
              ],
              [
                "screenId"=> "58",
                "keyword_id"=> 605,
          ...
          [
            ...
            "keyword_data"=>[
              ...
              [
                ...
                "keyword_value"=> "New update for app available please update!."
              ]
            ]]
        ];
